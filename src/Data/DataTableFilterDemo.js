...
const DataTableFilterDemo = () => {
    ...
    const countryBodyTemplate = (rowData) => {
        return (
            <React.Fragment>
                {DataArray.map((value)=>{
                        return <img alt="flag" src={value} className={`flag flag-${rowData.country.code}`} width={30} />
                })}
                {/* <img alt="flag" src="/images/flag/flag_placeholder.png" onError={(e) => e.target.src = 'https://images.unsplash.com/flagged/photo-1562599838-8cc871c241a5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8cGl4ZWx8ZW58MHx8MHx8&w=1000&q=80'} className={`flag flag-${rowData.country.code}`} width={30} /> */}
    ...
    const representativeBodyTemplate = (rowData) => {
        ...
        return (
            <React.Fragment>
                <img alt={representative.name} src={`images/avatar/${representative.image}`} onError={(e) => e.target.src = 'https://images.unsplash.com/flagged/photo-1562599838-8cc871c241a5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8cGl4ZWx8ZW58MHx8MHx8&w=1000&q=80'} width={32} style={{ verticalAlign: 'middle' }} />
